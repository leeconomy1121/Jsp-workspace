    ...
    <header>
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: tomato">
        <div class="container-fluid">
          <a class="navbar-brand" href="<%=request.getContextPath()%>/todos?action=list">TODO APP</a>
          <button
          ...
          <c:forEach var="todo" items="${listTodo}">
            <tr>
              ...
              <td>
                ...
                <a href="<%=request.getContextPath()%>/todos?action=delete&id=<c:out value='${todo.id}' />" onclick="if(!confirm('정말로 삭제하겠습니까?')) return false" class="btn btn-danger btn-sm">삭제</a>
              </td>
            </tr>
          </c:forEach>
        </tbody>
